...
int parseBoschComent(string s, string &brief, vector<string> &param, string &ret) {
    ...
    while (getline(ss, line)) {
        ...
        switch (currentSection) {
            ...
            default:
                // Section 0 or 1 (Definition): 
                // Any text here that isn't a Tag is considered "Noise" (Copyright, License, Config logs)
                // We mark this as OTHERS to prevent data loss.
